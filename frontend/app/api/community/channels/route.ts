...
export async function GET(request: NextRequest) {
  try {
    const backendUrl = `${BACKEND_URL}/api/community/channels`;
    
    console.log(`Community channels API: GET ${backendUrl}`);
    ...
    console.log(`Community channels response: ${response.status} ${response.statusText}`);
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log(`Community channels API: POST ${backendUrl}`);
