        ...
        >
          ...
          {success && (
            <motion.div
              ...
              className="mb-6 p-4 bg-green-50 border border-green-200 rounded-xl text-green-700 text-sm flex items-center"
            >
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="space-y-3">
                <label className="flex items-center p-3 border border-gray-300 rounded-xl cursor-pointer hover:border-blue-500 transition-colors">
                  <input
                    type="radio"
                    name="paymentMethod"
                    value="credit_card"
                  ...
                  <span className="text-sm">Credit Card (International)</span>
                </label>
                <label className="flex items-center p-3 border border-gray-300 rounded-xl cursor-pointer hover:border-blue-500 transition-colors">
                  <input
                    type="radio"
                    ...
                    className="mr-3 text-blue-600"
                  />
                  <span className="text-sm">Easypaisa (Pakistan)</span>
                </label>
                <label className="flex items-center p-3 border border-gray-300 rounded-xl cursor-pointer hover:border-blue-500 transition-colors">
                  <input
                    type="radio"
                    ...
                    className="mr-3 text-blue-600"
                  />
                  <span className="text-sm">Jazz Cash (Pakistan)</span>
                </label>
              </div>
            </div>
            ...
            <div className="bg-gray-50 p-4 rounded-xl">
              <div className="flex justify-between items-center text-sm">
                ...
                <span className="font-medium">${signupFee}</span>
              </div>
              {promoDiscount > 0 && (
