    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-300">Create and manage assignments across all your courses</p>
        </div>
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center">
                        ...
                        <div className="ml-4">
                          ...
                          <div className="text-sm text-gray-500 dark:text-gray-400 max-w-xs truncate">{assignment.description}</div>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                      <div className="flex space-x-2">
                        <button
                          ...
                          className="text-blue-600 hover:text-blue-900 dark:hover:text-blue-400 p-1 transition-colors"
                        ...
                        <button
                          ...
                          className="text-green-600 hover:text-green-900 dark:hover:text-green-400 p-1 transition-colors"
                        ...
                        <button
                          ...
                          className="text-red-600 hover:text-red-900 dark:hover:text-red-400 p-1 transition-colors"
