    ...
    >
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">Manage platform notifications and communications</p>
        </div>
          ...
          <div className="bg-white rounded-2xl border border-gray-200 shadow-lg">
            ...
            <div className="overflow-hidden">
              {templates.map((template) => (
                <div key={template.id} className="p-6 border-b border-gray-100 hover:bg-gray-50 transition-colors">
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <div className="flex items-center space-x-3 mb-2">
                      ...
                      <p className="text-gray-600 mb-2"><strong>Subject:</strong> {template.subject}</p>
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <div className="flex items-center space-x-3 mb-2">
                        ...
                        <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                          notification.status === 'read' ? 'text-green-600 bg-green-100' : 
                          notification.status === 'delivered' ? 'text-blue-600 bg-blue-100' : 
