...
const styles = StyleSheet.create({
  ...
  pkgCard: { flexDirection: 'row', alignItems: 'center', backgroundColor: 'rgba(8,20,48,0.85)', borderRadius: 12, borderWidth: 1, borderColor: 'rgba(255,255,255,0.1)', padding: 14, marginBottom: 8, gap: 10 },
